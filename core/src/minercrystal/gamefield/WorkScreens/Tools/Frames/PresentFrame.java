...
public class PresentFrame implements FrameInterface {
    ...
    public PresentFrame(Rectangle frameRectangle, BitmapFont bitmapFont, I18NBundle myBundle, AdsController adsController) {
    ...
    public void render(SpriteBatch spriteBatch, float delta) {
        ...
        if (isFrameActive) {
            ...
            spriteBatch.end();
            frameRedButton.render(delta, spriteBatch, "MENU");
             spriteBatch.begin();
